...
| **건축년도** | 에너지절약설계기준 개정 시점 기준 | pre-1980, 1980-2000, 2001-2010, post-2010 (4구간) ← DB vintage_class 값과 일치 |
...
| 건축년도 (vintage_class) | 외벽 | 지붕 | 바닥 | 창호 | 근거 |
|-------------------------|------|------|------|------|------|
| ~1979 (pre-1980) | 0.70 | 0.50 | 0.70 | 4.00 | 1980년 이전, 단열 기준 미적용 |
| 1980~2000 (1980-2000) | 0.58 | 0.41 | 0.58 | 3.40 | 구 에너지절약설계기준 |
| 2001~2010 (2001-2010) | 0.47 | 0.29 | 0.47 | 2.70 | 에너지절약설계기준 개정 |
| 2011~ (post-2010) | 0.27 | 0.17 | 0.27 | 1.50 | 강화 기준 (현행 근사) |

> ⚠️ vintage_class 구분은 DB `buildings_enriched.vintage_class` 컬럼 값과 동일해야 archetype 매칭이 작동한다. (SSOT: db/views.sql)
