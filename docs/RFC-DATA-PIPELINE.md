...
**문서 버전**: 1.1
**작성일**: 2026-03-21
**최종 수정**: 2026-03-27 (건축물대장 1,160,817건 · 에너지 Tier1~4 수집 완료)
**관련 문서**: [PRD](./PRD.md) | [Architecture](./ARCHITECTURE.md)
**대상 지역**: 서울특별시 전역 25개 구 (초기 마포구 11440 → 서울 전역 확장 완료)

---

## 1. 개요

서울특별시 전역 **766,386동**의 건물을 3D 에너지 시각화하기 위한 데이터 수집 → 통합 → 3D Tiles 생성 파이프라인. (초기 마포구 약 25K~30K에서 서울 전역으로 확장 완료)
