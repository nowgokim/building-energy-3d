...
def load_footprints_from_vworld(
    ...
    Returns:
        Number of records loaded into the database.
    """
    # 마포구 전체 bbox를 ~3km 타일로 분할 (10km 제한 준수)
    # 마포구 행정경계: 약 126.85~126.97, 37.53~37.59
    TILES = [
        (126.850, 37.530, 126.885, 37.560),
        (126.885, 37.530, 126.920, 37.560),
        (126.920, 37.530, 126.955, 37.560),
        (126.955, 37.530, 126.975, 37.560),
        (126.850, 37.560, 126.885, 37.595),
        (126.885, 37.560, 126.920, 37.595),
        (126.920, 37.560, 126.955, 37.595),
        (126.955, 37.560, 126.975, 37.595),
    ]
